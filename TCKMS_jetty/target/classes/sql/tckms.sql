...
INSERT INTO `authority_table` VALUES ('2', 'edit_videos', '编辑任意视频');
INSERT INTO `authority_table` VALUES ('3', 'del_videos', '删除任意视频');
INSERT INTO `authority_table` VALUES ('4', 'add_video', '添加视频');
INSERT INTO `authority_table` VALUES ('5', 'add_comment', '发表评论');
INSERT INTO `authority_table` VALUES ('6', 'del_comment', '删除任意评论');
...
CREATE TABLE `news_table` (
  ...
  `news_info` varchar(1000) NOT NULL DEFAULT '',
  `user_id` mediumint(10) unsigned NOT NULL,
  `news_date` date NOT NULL,
  PRIMARY KEY (`news_id`),
  KEY `user_id` (`user_id`),
  CONSTRAINT `news_table_ibfk_1` FOREIGN KEY (`user_id`) REFERENCES `user_table` (`user_id`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB AUTO_INCREMENT=6 DEFAULT CHARSET=utf8;

-- ----------------------------
-- Records of news_table
-- ----------------------------
INSERT INTO `news_table` VALUES ('1', '关于近期，做完题后没有成绩的说明。11', '大家好，近期，很多同学做完题后没有成绩。据了解，出现故障的大多都是因为做了客户端上出现的重复的题目，现在还在联系广东省考试中心的老师找处理办法。\r\r\n在这期间，请各位同学，不要做客户端上出现的重复的题目，或者只做其中的一道题。\r\r\n再次说明：重复的题目做一个就够了，不要多做，没必要通过这个办法增加知识点通过数，有可能因为做了重复的题目反而出现错误，导致没有成绩\r。', '1', '2012-06-04');
INSERT INTO `news_table` VALUES ('2', '关于近期，做完题后没有成绩的说明。22', '大家好，近期，很多同学做完题后没有成绩。据了解，出现故障的大多都是因为做了客户端上出现的重复的题目，现在还在联系广东省考试中心的老师找处理办法。\r\r\n在这期间，请各位同学，不要做客户端上出现的重复的题目，或者只做其中的一道题。\r\r\n再次说明：重复的题目做一个就够了，不要多做，没必要通过这个办法增加知识点通过数，有可能因为做了重复的题目反而出现错误，导致没有成绩\r。。', '1', '2012-06-04');
INSERT INTO `news_table` VALUES ('3', '关于近期，做完题后没有成绩的说明。33', '大家好，近期，很多同学做完题后没有成绩。据了解，出现故障的大多都是因为做了客户端上出现的重复的题目，现在还在联系广东省考试中心的老师找处理办法。\r\r\n在这期间，请各位同学，不要做客户端上出现的重复的题目，或者只做其中的一道题。\r\r\n再次说明：重复的题目做一个就够了，不要多做，没必要通过这个办法增加知识点通过数，有可能因为做了重复的题目反而出现错误，导致没有成绩\r。', '1', '2012-06-01');
INSERT INTO `news_table` VALUES ('4', '关于近期，做完题后没有成绩的说明。44', '大家好，近期，很多同学做完题后没有成绩。据了解，出现故障的大多都是因为做了客户端上出现的重复的题目，现在还在联系广东省考试中心的老师找处理办法。\r\r\n在这期间，请各位同学，不要做客户端上出现的重复的题目，或者只做其中的一道题。\r\r\n再次说明：重复的题目做一个就够了，不要多做，没必要通过这个办法增加知识点通过数，有可能因为做了重复的题目反而出现错误，导致没有成绩\r。', '1', '2012-06-01');
INSERT INTO `news_table` VALUES ('5', '关于近期，做完题后没有成绩的说明。55', '大家好，近期，很多同学做完题后没有成绩。据了解，出现故障的大多都是因为做了客户端上出现的重复的题目，现在还在联系广东省考试中心的老师找处理办法。\r\r\n在这期间，请各位同学，不要做客户端上出现的重复的题目，或者只做其中的一道题。\r\r\n再次说明：重复的题目做一个就够了，不要多做，没必要通过这个办法增加知识点通过数，有可能因为做了重复的题目反而出现错误，导致没有成绩\r。', '1', '2012-06-01');
...
INSERT INTO `role_authority_table` VALUES ('2', '1', '4');
...
-- ----------------------------
INSERT INTO `role_table` VALUES ('1', '普通用户', '仅能观看、上传、评论、收藏视频', '用户');
...
-- ----------------------------
INSERT INTO `table_favorites` VALUES ('1', '524', '1', '2012-05-31 22:28:32');
...
INSERT INTO `table_msgboard` VALUES ('14', '563', '1', '2012-05-31 22:33:52', 'asdsad', '我是普通用户');
INSERT INTO `table_msgboard` VALUES ('15', '563', '1', '2012-05-31 22:33:54', 'asdsad', '我是普通用户');
INSERT INTO `table_msgboard` VALUES ('16', '563', '1', '2012-05-31 22:33:55', 'asdsad', '我是普通用户');
INSERT INTO `table_msgboard` VALUES ('17', '524', '1', '2012-06-04 08:40:03', 'ppp', '我是普通用户');
INSERT INTO `table_msgboard` VALUES ('18', '564', '1', '2012-06-04 08:42:20', 'opop', '我是普通用户');
INSERT INTO `table_msgboard` VALUES ('19', '565', '1', '2012-06-05 16:24:11', '顶戴顶戴', '我是普通用户');
INSERT INTO `table_msgboard` VALUES ('20', '18', '1', '2012-06-05 16:28:00', '', '我是普通用户');
...
INSERT INTO `video_table` VALUES ('18', '2222222222.mp4', 'Android开发视频教学 01_05_Activity和Intent', 'Android教学视频第一季', 'upload/videos/2222222222.mp4', 'android', '2012-04-15', '2012-06-05 16:27:46', '56', '通过', '62', '0:33:30', 'upload/vimgs/2222222222.PNG', '2', '2');
...
INSERT INTO `video_table` VALUES ('319', 'sdfsdfsdfsdfw2.FLV', '黑马程序员_毕向东_Java基础视频教程第07天-01-面向对象(继承-概述)', 'JAVA', 'upload/videos/sdfsdfsdfsdfw2.FLV', 'java', '2012-04-15', '2012-06-04 08:44:09', '101', '通过', '62', '0:33:30', 'upload/vimgs/sdfsdfsdfsdfw2.PNG', '3', '2');
...
INSERT INTO `video_table` VALUES ('519', '2222222222.mp4', 'Android开发视频教学 01_05_Activity和Intent', 'Android教学视频第一季', 'upload/videos/2222222222.mp4', 'android', '2012-04-15', '2012-05-31 22:29:13', '59', '通过', '62', '0:33:30', 'upload/vimgs/2222222222.PNG', '2', '2');
...
INSERT INTO `video_table` VALUES ('524', '2222222222.mp4', 'Android开发视频教学 01_05_Activity和Intent', 'Android教学视频第一季', 'upload/videos/2222222222.mp4', 'android', '2012-04-15', '2012-06-04 08:39:47', '101', '通过', '62', '0:33:30', 'upload/vimgs/2222222222.PNG', '2', '2');
INSERT INTO `video_table` VALUES ('525', 'sdfsdfsdfsdfw2.FLV', '黑马程序员_毕向东_Java基础视频教程第07天-01-面向对象(继承-概述)', 'JAVA', 'upload/videos/sdfsdfsdfsdfw2.FLV', 'java', '2012-04-15', '2012-06-04 08:45:55', '143', '通过', '62', '0:33:30', 'upload/vimgs/sdfsdfsdfsdfw2.PNG', '3', '2');
INSERT INTO `video_table` VALUES ('526', '1asdsadasd.FLV', '黑马程序员_毕向东_Java基础视频教程第07天-02-面向对象(继承-概述2)', 'JAVA', 'upload/videos/1asdsadasd.FLV', 'java', '2012-04-15', '2012-05-31 22:32:21', '46', '通过', '62', '0:33:30', 'upload/vimgs/sdfsdfsdfsdfw2.PNG', '3', '2');
...
INSERT INTO `video_table` VALUES ('530', '966e66b1-d173-4d17-90a3-2058e0e0d58f.mp4', 'mcccc', 'mcmcmcmcm', 'upload/videos/966e66b1-d173-4d17-90a3-2058e0e0d58f.mp4', 'mccc,xsds,ccc,', '2012-05-16', '2012-05-31 22:32:43', '13', '通过', '1015917', '', 'upload/vimgs/null.jpg', '2', '1');
...
INSERT INTO `video_table` VALUES ('548', 'cf06f7c6-6e86-4dc6-8acd-03e8e6a93b3e.mp4', 'sdfasdasd', 'asdasdasdasdasdasd', 'resource/videos/cf06f7c6-6e86-4dc6-8acd-03e8e6a93b3e.mp4', 'sadasd,', '2012-05-28', '2012-05-28 15:55:31', '0', '不通过', '1021023', '', 'resource/vimgs/null.jpg', '10', '1');
INSERT INTO `video_table` VALUES ('549', '29179059-9e85-4b71-a817-ddf708cb9dc8.mp4', 'aaascasc', 'ascascasc', 'resource/videos/29179059-9e85-4b71-a817-ddf708cb9dc8.mp4', 'ascsacasc,', '2012-05-28', '2012-05-28 21:50:44', '0', '不通过', '1021023', '', 'resource/vimgs/null.jpg', '2', '1');
INSERT INTO `video_table` VALUES ('550', '8deea074-4609-43d2-a84a-ea0a19504752.mp4', 'zxczxc', 'xzczxc', 'resource/videos/8deea074-4609-43d2-a84a-ea0a19504752.mp4', 'zxcczxc,', '2012-05-31', '2012-05-31 20:39:35', '0', '不通过', '1032278', '', 'resource/vimgs/null.jpg', '2', '1');
INSERT INTO `video_table` VALUES ('551', '4c88e9d1-9ba5-4684-bcf2-be5a8721d6e1.mp4', 'asdasd', 'sadasd', 'resource/videos/4c88e9d1-9ba5-4684-bcf2-be5a8721d6e1.mp4', 'asdasd,', '2012-05-31', '2012-06-04 22:57:24', '2', '通过', '3063712', '', 'resource/vimgs/null.jpg', '2', '1');
INSERT INTO `video_table` VALUES ('552', 'd5b12e3b-feab-4c28-9459-477c6eb1f56d.mp4', 'asdasda', 'sdasdasd', 'resource/videos/d5b12e3b-feab-4c28-9459-477c6eb1f56d.mp4', 'sadasd,', '2012-05-31', '2012-05-31 20:52:10', '0', '不通过', '1033262', '', 'resource/vimgs/null.jpg', '2', '1');
INSERT INTO `video_table` VALUES ('553', '0df7387f-8286-49b7-8aed-7c397ff2c6f4.mp4', 'dfgsdfgdf', 'sgsdfg', 'resource/videos/0df7387f-8286-49b7-8aed-7c397ff2c6f4.mp4', 'dfgdsfg,', '2012-05-31', '2012-05-31 21:24:49', '0', '不通过', '1033262', '', 'resource/vimgs/null.jpg', '9', '1');
INSERT INTO `video_table` VALUES ('554', '01106745-1f0f-4343-b9c5-ba87c1a2f66a.mp4', 'dsafasdf', 'asdfasdf', 'resource/videos/01106745-1f0f-4343-b9c5-ba87c1a2f66a.mp4', 'sadfasdf,', '2012-05-31', '2012-05-31 21:46:37', '0', '不通过', '21603730', '', 'resource/vimgs/null.jpg', '2', '1');
INSERT INTO `video_table` VALUES ('555', 'bf220192-3be9-4e0c-b50d-6739e14d6e3c.mp4', 'ASDFASDF', 'SADFASDF', 'resource/videos/bf220192-3be9-4e0c-b50d-6739e14d6e3c.mp4', 'SDAFASDF,', '2012-05-31', '2012-05-31 21:53:03', '0', '不通过', '1044379', '', 'resource/vimgs/null.jpg', '2', '1');
INSERT INTO `video_table` VALUES ('556', 'f676f821-8da7-4697-875e-0a0a2f1f1315.mp4', 'ASDASDA', 'SDASDASD', 'resource/videos/f676f821-8da7-4697-875e-0a0a2f1f1315.mp4', 'ASDASD,', '2012-05-31', '2012-05-31 21:53:37', '0', '不通过', '1033262', '', 'resource/vimgs/null.jpg', '2', '1');
INSERT INTO `video_table` VALUES ('557', '198ee482-70b0-442e-a1a0-3c746fe3c1f6.mp4', 'asdasdasd', 'asdasd', 'resource/videos/198ee482-70b0-442e-a1a0-3c746fe3c1f6.mp4', 'sadasd,', '2012-05-31', '2012-05-31 22:12:16', '0', '不通过', '1043044', '', 'resource/vimgs/null.jpg', '2', '1');
INSERT INTO `video_table` VALUES ('558', 'ae1148f4-d443-467e-8205-4d18d73ed5a3.mp4', 'asdasd', 'asdasd', 'resource/videos/ae1148f4-d443-467e-8205-4d18d73ed5a3.mp4', 'asdasd,', '2012-05-31', '2012-05-31 22:12:34', '0', '不通过', '21603730', '', 'resource/vimgs/null.jpg', '2', '1');
INSERT INTO `video_table` VALUES ('559', 'c1efb1bb-eb5a-4609-9343-dfe6beb450ab.mp4', 'asdasdasd', 'asdasdasd', 'resource/videos/c1efb1bb-eb5a-4609-9343-dfe6beb450ab.mp4', 'asdas,', '2012-05-31', '2012-05-31 22:17:57', '0', '不通过', '3063712', '', 'resource/vimgs/null.jpg', '2', '1');
INSERT INTO `video_table` VALUES ('560', '332c5a43-3ecb-42a6-b76d-2ac09e0beed7.mp4', 'asdasdasd', 'sadasdasd', 'resource/videos/332c5a43-3ecb-42a6-b76d-2ac09e0beed7.mp4', 'asdasd,', '2012-05-31', '2012-05-31 22:18:20', '0', '不通过', '1043044', '', 'resource/vimgs/null.jpg', '2', '1');
INSERT INTO `video_table` VALUES ('561', '520856e2-8f72-4449-a88f-f5aee30c269d.mp4', 'sadfsdf', 'sadfsadfasdf', 'resource/videos/520856e2-8f72-4449-a88f-f5aee30c269d.mp4', 'sdafasdf,', '2012-05-31', '2012-05-31 22:21:27', '0', '不通过', '1043044', '', 'resource/vimgs/null.jpg', '4', '1');
INSERT INTO `video_table` VALUES ('562', '328b91a0-969c-4265-87a1-d365612c10be.mp4', 'sadfsadf', 'sadfasdf', 'resource/videos/328b91a0-969c-4265-87a1-d365612c10be.mp4', 'sasdf,', '2012-05-31', '2012-05-31 22:21:47', '0', '不通过', '2069220', '', 'resource/vimgs/null.jpg', '2', '1');
INSERT INTO `video_table` VALUES ('563', '257747a3-3124-4d78-8578-450c5fa105d2.mp4', 'asdfadf', 'asdfsadfas', 'resource/videos/257747a3-3124-4d78-8578-450c5fa105d2.mp4', 'asdfsfa,', '2012-05-31', '2012-06-04 22:58:10', '8', '通过', '21603730', '', 'resource/vimgs/null.jpg', '2', '1');
INSERT INTO `video_table` VALUES ('564', 'abd2e17b-e01c-42b2-94de-7a0bab40b05d.mp4', 'pppppp', 'qeqweqeqeqeqw', 'resource/videos/abd2e17b-e01c-42b2-94de-7a0bab40b05d.mp4', 'ppp,p,', '2012-06-04', '2012-06-04 23:11:35', '6', '通过', '61756116', '', 'resource/vimgs/null.jpg', '2', '1');
INSERT INTO `video_table` VALUES ('565', '46f02378-3501-4610-8b6a-c73fd689d6a4.mp4', 'NBA阿方索', '撒旦飞洒地方', 'resource/videos/46f02378-3501-4610-8b6a-c73fd689d6a4.mp4', '圣达菲阿士大夫,', '2012-06-05', '2012-06-05 16:38:05', '4', '通过', '57107130', '', 'resource/vimgs/null.jpg', '10', '1');
INSERT INTO `video_table` VALUES ('566', '8c5be814-71f1-4063-9702-d50add9ca88a.mp4', '湖人NBA', '撒旦飞洒地方', 'resource/videos/8c5be814-71f1-4063-9702-d50add9ca88a.mp4', '撒旦法师打发,', '2012-06-05', '2012-06-06 16:31:22', '7', '通过', '61756116', '', 'resource/vimgs/null.jpg', '2', '1');
INSERT INTO `video_table` VALUES ('567', '46ad67d1-d515-4494-bf01-baa8f2c2a482.mp4', 'asdaa', 'asdasd', 'resource/videos/46ad67d1-d515-4494-bf01-baa8f2c2a482.mp4', 'asd,', '2012-06-05', '2012-06-05 16:48:45', '0', '不通过', '1044379', '', 'resource/vimgs/null.jpg', '2', '1');
INSERT INTO `video_table` VALUES ('568', '540cc152-e2e6-4482-8fc1-8475f238b147.mp4', '阿斯达asdasd', 'asdasdasd', 'resource/videos/540cc152-e2e6-4482-8fc1-8475f238b147.mp4', 'asdasd,', '2012-06-06', '2012-06-06 15:08:29', '0', '不通过', '21331959', '', 'resource/vimgs/null.jpg', '2', '1');
INSERT INTO `video_table` VALUES ('569', '809f633a-1257-4305-a3b0-fb65b2be7727.mp4', 'asdas', 'asdasdasd', 'resource/videos/809f633a-1257-4305-a3b0-fb65b2be7727.mp4', 'asdasd,', '2012-06-06', '2012-06-06 16:28:26', '0', '不通过', '57107130', '', 'resource/vimgs/null.jpg', '2', '1');
INSERT INTO `video_table` VALUES ('570', '3c4f0d7f-b791-4b97-974a-6dede97fb961.mp4', 'asdasd', 'sadasda', 'resource/videos/3c4f0d7f-b791-4b97-974a-6dede97fb961.mp4', 'aaa,', '2012-06-06', '2012-06-06 16:38:05', '0', '不通过', '63988569', '', 'resource/vimgs/null.jpg', '2', '1');
...
-- ----------------------------
-- View structure for `role_authority_view`
-- ----------------------------
DROP VIEW IF EXISTS `role_authority_view`;
CREATE ALGORITHM=UNDEFINED DEFINER=`root`@`localhost` SQL SECURITY DEFINER VIEW `role_authority_view` AS select `authority_table`.`authority_id` AS `authority_id`,`authority_table`.`authority_name` AS `authority_name`,`authority_table`.`authority_description` AS `authority_description`,`role_authority_table`.`role_authority_id` AS `role_authority_id`,`role_table`.`role_id` AS `role_id` from ((`role_table` join `role_authority_table`) join `authority_table`) where ((`role_table`.`role_id` = `role_authority_table`.`role_id`) and (`authority_table`.`authority_id` = `role_authority_table`.`authority_id`)) ;

-- ----------------------------
-- View structure for `user_role_view`
-- ----------------------------
DROP VIEW IF EXISTS `user_role_view`;
CREATE ALGORITHM=UNDEFINED DEFINER=`root`@`localhost` SQL SECURITY DEFINER VIEW `user_role_view` AS select `role_table`.`role_id` AS `role_id`,`user_table`.`user_id` AS `user_id`,`role_table`.`role_name` AS `role_name`,`role_table`.`role_description` AS `role_description`,`role_table`.`role_type` AS `role_type`,`user_role_table`.`user_role_id` AS `user_role_id` from ((`role_table` join `user_table`) join `user_role_table`) where ((`role_table`.`role_id` = `user_role_table`.`role_id`) and (`user_table`.`user_id` = `user_role_table`.`user_id`)) ;
