...
<div id="latestUpload" class="fl">
	<a id="latestUpload_more" href="Home_VideoListLately.action?vtid=0" class="fr">更多&gt;&gt;</a>
	<h2 id="latestUpload_title">最新上传</h2>
   <c:forEach var="video" items="${requestScope.vlist_lately}" begin="0" end="3">
